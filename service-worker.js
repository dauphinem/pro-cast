const CACHE="pro-cast-v11-1-local";
const ASSETS=["./","./index.html","./styles.css","./v2.css","./v3.css","./v4.css","./drawer.css","./v9.css","./v9-fixes.css?v=11-local","./v11.css?v=11-1-local","./app.js?v=11-1-local","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png"];
