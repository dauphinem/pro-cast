const CACHE="pro-cast-v9-2-1";
const ASSETS=["./","./index.html","./styles.css","./v2.css","./v3.css","./v4.css","./drawer.css","./v9.css","./v9-fixes.css?v=9.2.1","./app.js","./manifest.webmanifest","./icons/icon-192.png","./icons/icon-512.png","./icons/apple-touch-icon.png"];
